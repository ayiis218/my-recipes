import type { IPropSvg } from "./svg.type"

export const SVG_Instagram = ({ classname = "", color, onClick }: IPropSvg) => {
   return (
      <svg
         className={classname}
         width="23"
...
export const SVG_Facebook = ({ classname = "", color, onClick }: IPropSvg) => {
   return (
      <svg
         className={classname}
         width="10"
...
export const SVG_Twitter = ({ classname = "", color, onClick }: IPropSvg) => {
   return (
      <svg
         className={classname}
         width="23"
